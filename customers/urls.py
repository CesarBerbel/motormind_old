...
urlpatterns = [
    ...
    path(
        "clientes/<int:pk>/editar/", views.customer_update_view, name="customer_update"
    ),
    path(
        "clientes/<int:pk>/excluir/", views.customer_delete_view, name="customer_delete"
    ),
    path(
        "clientes/<int:pk>/restaurar/",
        views.customer_restore_view,
    ...
    path(
        "veiculos/<int:pk>/excluir/", views.vehicle_delete_view, name="vehicle_delete"
    ),
    path(
        "veiculos/<int:pk>/restaurar/",
        views.vehicle_restore_view,
        name="vehicle_restore",
    ),
]
