...
CATEGORY_DESCRIPTIONS = {
    "Filtros e lubrificação": "Filtros, óleos e fluidos de manutenção preventiva.",
    "Arrefecimento": "Componentes do sistema de arrefecimento do motor.",
    "Freios": "Componentes hidráulicos, mecânicos e eletrônicos do sistema de freios.",
    "Direção": "Componentes de direção mecânica, hidráulica e elétrica.",
    "Suspensão": "Componentes de suspensão, estabilidade e absorção de impacto.",
    "Rodas e cubos": "Rolamentos, cubos e componentes associados às rodas.",
    "Ignição": "Componentes de ignição e centelha.",
    "Injeção eletrônica": "Sensores e atuadores do gerenciamento eletrônico do motor.",
    "Alimentação": "Componentes de alimentação de combustível e ar.",
    "Motor": "Componentes internos, vedações e periféricos do motor.",
    "Câmbio e embreagem": "Componentes de transmissão manual, câmbio e embreagem.",
    "Transmissão": "Componentes de transmissão e juntas homocinéticas.",
    "Elétrica": "Componentes elétricos e sistemas de carga/partida.",
    "Iluminação": "Lâmpadas e componentes de iluminação automotiva.",
    "Acessórios e acabamento": "Peças de acabamento, acesso, limpeza e acessórios comuns.",
    "Ar-condicionado": "Componentes e consumíveis do sistema de climatização.",
    "Escapamento": "Componentes do sistema de exaustão e escapamento.",
}


APPLICATIONS = [
    {
        "suffix": "Linha leve flex",
        "price_factor": Decimal("1.00"),
        "stock": Decimal("8.00"),
    },
    {
        "suffix": "Hatch compacto",
        "price_factor": Decimal("0.95"),
        "stock": Decimal("10.00"),
    },
    {
        "suffix": "Sedan compacto",
        "price_factor": Decimal("1.05"),
        "stock": Decimal("8.00"),
    },
    {
        "suffix": "SUV compacto",
        "price_factor": Decimal("1.18"),
        "stock": Decimal("6.00"),
    },
    {
        "suffix": "Pick-up leve",
...
COMPONENTS = [
    ...
    {
        "name": "Óleo de motor 10W40 semissintético",
        "category": "Filtros e lubrificação",
        "cost": "28.00",
        "sale": "50.00",
        "minimum": "12.00",
    ...
    {
        "name": "Óleo de motor 15W40 mineral",
        "category": "Filtros e lubrificação",
        "cost": "22.00",
        "sale": "42.00",
        "minimum": "10.00",
    ...
    {
        "name": "Flexível de freio dianteiro",
        "category": "Freios",
        "cost": "32.00",
        "sale": "75.00",
        "minimum": "2.00",
    ...
    {
        "name": "Coxim do amortecedor dianteiro",
        "category": "Suspensão",
        "cost": "70.00",
        "sale": "145.00",
        "minimum": "2.00",
    ...
    {
        "name": "Kit batente e coifa dianteiro",
        "category": "Suspensão",
        "cost": "55.00",
        "sale": "120.00",
        "minimum": "2.00",
    ...
    {
        "name": "Kit batente e coifa traseiro",
        "category": "Suspensão",
        "cost": "48.00",
        "sale": "105.00",
        "minimum": "2.00",
    ...
    {
        "name": "Refil da bomba de combustível",
        "category": "Alimentação",
        "cost": "85.00",
        "sale": "180.00",
        "minimum": "2.00",
    ...
    },
    {
        ...
        "category": "Acessórios e acabamento",
        "cost": "28.00",
        "sale": "65.00",
        "minimum": "5.00",
    },
    {
        "name": "Palheta traseira",
        "category": "Acessórios e acabamento",
        "cost": "22.00",
        "sale": "52.00",
        "minimum": "3.00",
    ...
    {
        "name": "Limpador de para-brisa reservatório",
        "category": "Acessórios e acabamento",
        "cost": "12.00",
        "sale": "28.00",
        "minimum": "6.00",
    ...
    {
        "name": "Botão interruptor do vidro",
        "category": "Elétrica",
        "cost": "45.00",
        "sale": "100.00",
        "minimum": "1.00",
    ...
    {
        "name": "Filtro secador do ar-condicionado",
        "category": "Ar-condicionado",
        "cost": "70.00",
        "sale": "155.00",
        "minimum": "1.00",
    ...
    {
        "name": "Abraçadeira de escapamento",
        "category": "Escapamento",
        "cost": "15.00",
        "sale": "38.00",
        "minimum": "5.00",
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        updated_count = 0
        sequence = 1
        randomizer = Random(20260506)

        self.stdout.write("Criando marcas conhecidas...")
        brands_by_name = {}
        ...
        self.stdout.write("Criando categorias de peças...")
        categories_by_name = {}
        category_names = sorted({component["category"] for component in COMPONENTS})
        ...
        for component in COMPONENTS:
            for application in APPLICATIONS:
                ...
                selected_brand = brands_by_name[randomizer.choice(BRANDS)]
                category = categories_by_name[component["category"]]
        ...
        self.stdout.write(f"Marcas disponíveis: {len(brands_by_name)}")
        self.stdout.write(f"Categorias disponíveis: {len(categories_by_name)}")

        if total != 500:
            self.stdout.write(
                self.style.WARNING(
                    f"Atenção: total esperado era 500, mas foram processadas {total}."
                )
            )
