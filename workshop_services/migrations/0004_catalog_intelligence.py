        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "category_snapshot",
                    models.CharField(
                        blank=True, max_length=160, verbose_name="Categoria"
                    ),
                ),
                (
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=2, max_digits=10, verbose_name="Preço padrão"
                    ),
                ),
                (
                ...
                (
                    "parts_snapshot",
                    models.JSONField(
                        blank=True, default=list, verbose_name="Peças da versão"
                    ),
                ),
                (
                    "created_at",
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("service_parts_updated", "Peças do serviço atualizadas"),
                            ("combo_created", "Combo criado"),
                            ("combo_updated", "Combo atualizado"),
                            ("combo_items_updated", "Serviços do combo atualizados"),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="catalog_audit_logs",
                        to="workshop_services.servicecombo",
                        verbose_name="Combo",
                    ),
                ),
                (
